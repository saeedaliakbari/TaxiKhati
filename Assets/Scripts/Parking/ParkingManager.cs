...
public class ParkingManager : MonoBehaviour
{
    ...
    private void PrintLevelsCarsInPark()
    {
        ...
        Timer.Schedule(this, 0.5f, (Timer.Task)(() =>
        {
            ...
            if (ObscuredPrefs.GetInt("mainAchiv19") < carsLevel[37])
            {
                ObscuredPrefs.SetInt("mainAchiv19", carsLevel[37]);
            }
            if (ObscuredPrefs.GetInt("mainAchiv28") < carsLevel[49])
            {
                ObscuredPrefs.SetInt("mainAchiv28", carsLevel[49]);
            }
            if (ObscuredPrefs.GetInt("mainAchiv29") < carsLevel[66])
            {
                ObscuredPrefs.SetInt("mainAchiv29", carsLevel[66]);
            }
    ...
    private void CheckCarSpeedTycoon(int[] carsLevel)
    {
        ...
        if (levelSpeed > 19)
        {
            ...
            lblNewSpeed.SetActive(false);
            txtLevelSpeed.gameObject.SetActive(false);
            ////Debug.Log("FULL ");
        }
        else {
    ...
    private void CheckOfflineEarningTycoon(int[] carsLevel)
    {
        ...
        if (levelOfflineEarning > 19)
        {
            ...
            lblNewOffline.SetActive(false);
            txtLevelOfflineEarn.gameObject.SetActive(false);
            ////Debug.Log("FULL ");
        }
        else {
    ...
    private void CheckExchangeRateDecline(int[] carsLevel)
    {
        ...
        if (levelExchangeDecline > 19)
        {
            ...
            lblNewExchangeDecline.SetActive(false);
            txtLevelExchangeDecline.gameObject.SetActive(false);
        }
        else {
