...
public class CheckIABValidate : MonoBehaviour
{
    ...
    public void check(BazaarPurchase purchase, Action<bool, string, validateResult> mCallback)
    {
        if (purchase == null)
        {
    ...
    IEnumerator waitForRequest(WWW www)
    {
        ...
        if (www.error == null)
        {
            ...
            if (json["developerPayload"].Value.ToString() == currentPurchase.DeveloperPayload)
            {
